		...
		<div class="row">
			...
			<form action="saveBook.php" method="post" class="form-horizontal">
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						...
						<?php foreach ($author as $r): ?>
							<?php if ($r['author_id'] == $row['author_id']): ?>
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<input type="date" name="pub_date" required="required" class="form-control" id="pub_date">
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						<input type="text" name="pub_type" class="form-control" id="pub_type">
					</div>
				</div>
				<div class="form-group">
				...
				<table class="small table table-condensed table-striped">
					...
					<tbody>
						<?php foreach ($books as $r): ?>
							<tr><td><a href="addBooks.php?bid=<?=$r['book_id']?>"><?=$r['title']?></a></td><td><?=$r['author']?></td></tr>
						<?php endforeach ?>
					</tbody>
				</table>
			<?php else: ?>
